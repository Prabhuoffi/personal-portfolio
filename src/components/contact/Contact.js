        ...
        <div className="w-full h-auto flex flex-col lgl:flex-row justify-between">
          ...
          <div className="w-full lgl:w-[60%] h-full py-10 bg-gradient-to-r shadow-lg  flex flex-col gap-8 p-4 lgl:p-8 ">
            <form className="w-full flex flex-col gap-4 lgl:gap-6 py-2 lgl:py-5">
              ...
              {successMsg && (
                <p className="py-3 bg-gradient-to-shadow-shadowOne text-center text-green-500 text-base tracking-wide ">
                  {successMsg}
                </p>
              )}
              ...
              <div className="flex flex-col gap-4">
                ...
                <textarea
                  ...
                  value={message}
                  className={`${
                    errMsg === "Message is required!" && "outline-red-500"
                  } contactTextArea`}
                  cols="30"
                  rows="8"
                ></textarea>
              ...
              {errMsg && (
                <p className="py-3 bg-red-500  text-center text-white text-base tracking-wide ">
                  {errMsg}
                </p>
              )}
              {successMsg && (
                <p className="py-3 bg-gradient-to-r  text-center text-green-500 text-base tracking-wide ">
                  {successMsg}
                </p>
              )}
            </form>
